  ...
  <div class="l-wrapper">
    <header class="l-siteHeader" role="banner">
      ...
      <div class="b-siteHeader">
         <ul class="b-header__langSwitcher">
          <li class="b-langSwitcher__item"><a href="#" class="b-langSwitcher__link -state_current">RUS</a></li>
          <li class="b-langSwitcher__item"><a href="#" class="b-langSwitcher__link">ENG</a></li>
        </ul>
      </div>
      */ ?>
    </header>
